...
def test_apply_to_buffer_direct():
    ...
    for i in range(len(buffer)):
        assert buffer.get_led_8_bit(i) == Color8Bit(Color.YELLOW)
...
def test_apply_to_view_direct():
    ...
    assert buffer.get_led_8_bit(1) == Color8Bit(Color.BLACK)
    assert buffer.get_led_8_bit(2) == Color8Bit(Color.AQUA)
    assert buffer.get_led_8_bit(3) == Color8Bit(Color.AQUA)
    assert buffer.get_led_8_bit(4) == Color8Bit(Color.AQUA)
    assert buffer.get_led_8_bit(5) == Color8Bit(Color.BLACK)
...
def test_gradient_0_sets_to_black():
    ...
    for i in range(len(buffer)):
        assert buffer.get_led_8_bit(i) == Color8Bit(Color.BLACK)
...
def test_continuous_gradient_2_colors():
    ...
    assert buffer.get_led_8_bit(0) == Color8Bit(Color.YELLOW)
    assert buffer.get_led_8_bit(25) == lerp_rgb(Color.YELLOW, Color.PURPLE, 25 / 49.0)
    assert buffer.get_led_8_bit(49) == Color8Bit(Color.PURPLE)
    assert buffer.get_led_8_bit(73) == lerp_rgb(Color.YELLOW, Color.PURPLE, 25 / 49.0)
    assert buffer.get_led_8_bit(98) == Color8Bit(Color.YELLOW)
...
def test_discontinuous_gradient_2_colors():
    ...
    assert buffer.get_led_8_bit(0) == Color8Bit(Color.YELLOW)
    assert buffer.get_led_8_bit(49) == lerp_rgb(Color.YELLOW, Color.PURPLE, 0.5)
    assert buffer.get_led_8_bit(98) == Color8Bit(Color.PURPLE)
...
def test_scroll_forward():
    ...
    pattern = make_grayscale_pattern().scroll_at_relative_velocity(units.hertz(1 / 256.0))
    ...
    for time in range(10):
        ...
        for led in range(len(buffer)):
            ch = (led - time) % 256
            assert buffer.get_led_8_bit(led) == Color8Bit(ch, ch, ch)
...
def test_rainbow_at_full_size():
    ...
    for led in range(len(buffer)):
        assert buffer.get_led_8_bit(led) == Color8Bit(
...
def test_rainbow_odd_size():
    ...
    for led in range(len(buffer)):
        ...
        assert buffer.get_led_8_bit(led) == expected
...
def test_reverse_solid():
    ...
    for led in range(len(buffer)):
        assert buffer.get_led_8_bit(led) == Color8Bit(Color.ROSY_BROWN)
...
def test_offset_pattern(offset, expected):
    ...
    for led in range(len(buffer)):
        assert buffer.get_led_8_bit(led) == Color8Bit(expected[led % 3])
...
def test_blink_symmetric():
    ...
    for t in range(8):
        ...
        assert buffer.get_led_8_bit(0) == expected
...
def test_blink_in_sync():
    ...
    pattern.apply_to(buffer[:])
    assert buffer.get_led_8_bit(0) == Color8Bit(Color.BLACK)

    state["on"] = True
    pattern.apply_to(buffer[:])
    assert buffer.get_led_8_bit(0) == Color8Bit(Color.WHITE)
...
def test_breathe():
    ...
    pattern.apply_to(buffer[:])
    assert buffer.get_led_8_bit(0) == Color8Bit(Color(0.5, 0.5, 0.5))
...
def test_progress_mask_layer():
    ...
    for i in range(3):
        assert buffer.get_led_8_bit(i) == Color8Bit(Color.WHITE)
    for i in range(3, 10):
        assert buffer.get_led_8_bit(i) == Color8Bit(Color.BLACK)
...
def test_blend():
    ...
    buffer = AddressableLEDBuffer(1)
    pattern.apply_to(buffer[:])
    assert buffer.get_led_8_bit(0) == Color8Bit(Color(127, 0, 127))
...
def test_binary_mask():
    ...
    for i in range(2):
        assert buffer.get_led_8_bit(i) == Color8Bit(Color(123, 123, 123))
    for i in range(2, 4):
        assert buffer.get_led_8_bit(i) == Color8Bit(Color.BLACK)
