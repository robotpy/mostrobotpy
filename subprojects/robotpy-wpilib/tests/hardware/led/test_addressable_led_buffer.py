...
class TestAddressableLEDBuffer:
    ...
    def test_get_color(self):
        ...
        assert buffer.get_led_8_bit(0) == first_blue_color_8bit
        assert buffer.get_led_8_bit(1) == denim_color_8bit
        assert buffer.get_led_8_bit(2) == first_red_color_8bit
        assert buffer.get_led_8_bit(3) == first_blue_color_8bit
