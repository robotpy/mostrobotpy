...
import robotpy_apriltag.version
...
version = ".".join(robotpy_apriltag.version.version.split(".")[:2])
# The full version, including alpha/beta/rc tags.
release = robotpy_apriltag.version.version
...
htmlhelp_basename = "RobotPyapriltagdoc"
...
latex_documents = [
    (
        "index",
        "RobotPyapriltag.tex",
        "RobotPy apriltag Documentation",
