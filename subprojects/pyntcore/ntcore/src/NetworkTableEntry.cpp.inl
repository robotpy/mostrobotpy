...
cls_NetworkTableEntry
    ...
    .def("set_value", [](wpi::nt::NetworkTableEntry *self, std::string value) {
        return self->SetValue(wpi::nt::Value::MakeString(value));
    }, py::arg("value"), release_gil())
    .def("set_value", [](wpi::nt::NetworkTableEntry *self, py::sequence value) {
    ...
    .def("set_default_value", [](wpi::nt::NetworkTableEntry *self, std::string value) {
        return self->SetDefaultValue(wpi::nt::Value::MakeString(value));
    }, py::arg("value"), release_gil())
    .def("set_default_value", [](wpi::nt::NetworkTableEntry *self, py::sequence value) {
