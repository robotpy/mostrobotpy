cls_NetworkTable
    .def("getValue", [](const NetworkTable &self, std::string_view key, nb::handle defaultValue) -> nb::object {
    ...
    .def("putValue", [](nt::NetworkTable *self, std::string_view key, int64_t value) {
        return self->PutValue(key, nt::Value::MakeInteger(value));
    }, nb::arg("key"), nb::arg("value"), release_gil())
    ...
    .def("putValue", [](nt::NetworkTable *self, std::string_view key, nb::object value) {
    ...
    .def("setDefaultValue", [](nt::NetworkTable *self, std::string_view key, int64_t value) {
        return self->SetDefaultValue(key, nt::Value::MakeInteger(value));
    }, nb::arg("key"), nb::arg("value"), release_gil())
    ...
    .def("setDefaultValue", [](nt::NetworkTable *self, std::string_view key, nb::object value) {
        auto v = nt::Value::MakeRaw(nb::cast<std::span<const uint8_t>>(value));
        nb::gil_scoped_release release;
