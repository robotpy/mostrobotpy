...
version = ".".join(wpiutil.version.version.split(".")[:2])
# The full version, including alpha/beta/rc tags.
release = wpiutil.version.version
...
htmlhelp_basename = "RobotPyWPIUtildoc"
