...
version = ".".join(wpinet.version.version.split(".")[:2])
# The full version, including alpha/beta/rc tags.
release = wpinet.version.version
...
htmlhelp_basename = "RobotPywpinetdoc"
