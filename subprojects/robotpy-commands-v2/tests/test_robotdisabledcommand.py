...
def test_sequential_group_run_when_disabled(scheduler: commands2.CommandScheduler):
    ...
    command_1.runs_when_disabled = lambda: True
    command_2 = commands2.Command()
    command_2.runs_when_disabled = lambda: True
    command_3 = commands2.Command()
    command_3.runs_when_disabled = lambda: True
    command4 = commands2.Command()
    command4.runs_when_disabled = lambda: False

    run_when_disabled = commands2.SequentialCommandGroup(command_1, command_2)
    dont_run_when_disabled = commands2.SequentialCommandGroup(command_3, command4)
...
def test_parallel_group_run_when_disabled(scheduler: commands2.CommandScheduler):
    ...
    run_when_disabled = commands2.ParallelCommandGroup(command_1, command_2)
    dont_run_when_disabled = commands2.ParallelCommandGroup(command_3, command4)
...
def test_conditional_run_when_disabled(scheduler: commands2.CommandScheduler):
    ...
    run_when_disabled = commands2.ConditionalCommand(command_1, command_2, lambda: True)
    dont_run_when_disabled = commands2.ConditionalCommand(command_3, command4, lambda: True)
...
def test_select_run_when_disabled(scheduler: commands2.CommandScheduler):
    ...
    run_when_disabled = commands2.SelectCommand({1: command_1, 2: command_2}, lambda: 1)
    dont_run_when_disabled = commands2.SelectCommand({1: command_3, 2: command4}, lambda: 1)
...
def test_parallel_conditional_run_when_disabled_test(scheduler: commands2.CommandScheduler):
    DriverStationSim.set_enabled(False)
    DriverStationSim.notify_new_data()
