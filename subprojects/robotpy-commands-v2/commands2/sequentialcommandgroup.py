...
class SequentialCommandGroup(Command):
    ...
    def __init__(self, *commands: Command):
        ...
        self._interrupt_behavior = InterruptionBehavior.K_CANCEL_INCOMING
    ...
    def add_commands(self, *commands: Command):
        ...
        for command in commands:
            ...
            if command.get_interruption_behavior() == InterruptionBehavior.K_CANCEL_SELF:
                self._interrupt_behavior = InterruptionBehavior.K_CANCEL_SELF
