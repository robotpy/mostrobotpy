...
class CommandGamepad:
    ...
    def misc_1(self, loop: Optional[EventLoop] = None) -> Trigger:
    ...
    def misc_2(self, loop: Optional[EventLoop] = None) -> Trigger:
        return self.button(Gamepad.Button.MISC_2, loop)

    def misc_3(self, loop: Optional[EventLoop] = None) -> Trigger:
        return self.button(Gamepad.Button.MISC_3, loop)

    def misc_4(self, loop: Optional[EventLoop] = None) -> Trigger:
        return self.button(Gamepad.Button.MISC_4, loop)

    def misc_5(self, loop: Optional[EventLoop] = None) -> Trigger:
        return self.button(Gamepad.Button.MISC_5, loop)

    def misc_6(self, loop: Optional[EventLoop] = None) -> Trigger:
