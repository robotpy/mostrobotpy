...
class CommandSwitchN64Controller:
    ...
    def __init__(self, hid: Union[int, SwitchN64Controller]):
        """
    ...
    def button(
        self,
        button: SwitchN64Controller.Button,
        loop: Optional[EventLoop] = None,
    ) -> Trigger:
        """
        Constructs an event instance around this button's digital signal.

        :param button: the :class:`wpilib.SwitchN64Controller.Button` to read
    ...
    def a(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self.button(SwitchN64Controller.Button.A, loop)
    ...
    def CUp(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        :returns: a Trigger instance representing the C Up button's digital signal
                  attached to the given loop.
        """
        return self.button(SwitchN64Controller.Button.C_UP, loop)
    ...
    def capture(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        :returns: a Trigger instance representing the Capture button's digital signal
                  attached to the given loop.
        """
        return self.button(SwitchN64Controller.Button.CAPTURE, loop)
    ...
    def home(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        :returns: a Trigger instance representing the Home button's digital signal
                  attached to the given loop.
        """
        return self.button(SwitchN64Controller.Button.HOME, loop)
