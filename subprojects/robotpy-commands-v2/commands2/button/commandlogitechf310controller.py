...
class CommandLogitechF310Controller:
    ...
    def __init__(self, hid: Union[int, LogitechF310Controller]):
        ...
        if isinstance(hid, int):
            ...
            self._controller = LogitechF310Controller(self._hid.get_hid())
        else:
    ...
    def get_controller(self) -> LogitechF310Controller:
        """
    ...
    def get_axis(self, axis: LogitechF310Controller.Axis) -> float:
        """
