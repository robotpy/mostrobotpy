...
cls_Command
  ...
  .def("beforeStarting",
    [](std::shared_ptr<Command> self, std::function<void()> toRun, wpi::ArrayRef<std::shared_ptr<Subsystem>> requirements) {
    ...
    py::arg("toRun"), py::arg("requirements")=wpi::ArrayRef<std::shared_ptr<Subsystem> >{},
