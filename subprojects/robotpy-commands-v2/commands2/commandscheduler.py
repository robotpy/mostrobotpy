...
class CommandScheduler(Sendable):
        ...
        if self._requirements.keys().isdisjoint(requirements):
            ...
            for requirement in requirements:
                ...
                if (
                    ...
                    == InterruptionBehavior.K_CANCEL_INCOMING
                ):
                    return
    ...
    def register_subsystem(self, *subsystems: Subsystem) -> None:
        ...
        for subsystem in subsystems:
            ...
            if subsystem in self._subsystems:
                report_warning("Tried to register an already-registered subsystem", True)
                continue
    ...
    def set_default_command(self, subsystem: Subsystem, default_command: Command) -> None:
        """
