...
k_inches_per_foot = 12.0
k_meters_per_inch = 0.0254
k_seconds_per_minute = 60
k_milliseconds_per_second = 1000
k_kilograms_per_lb = 0.453592
...
def meters_to_feet(m: meters) -> feet:
    ...
    """
    return meters_to_inches(m) / k_inches_per_foot
...
def feet_to_meters(ft: feet) -> meters:
    ...
    """
    return inches_to_meters(ft * k_inches_per_foot)
...
def rotations_per_minute_to_radians_per_second(
    ...
    """
    return (rpm / k_seconds_per_minute) * math.tau
...
def radians_per_second_to_rotations_per_minute(
    ...
    """
    return (rps * k_seconds_per_minute) / math.tau
...
def milliseconds_to_seconds(ms: milliseconds) -> seconds:
    ...
    """
    return ms / k_milliseconds_per_second
...
def seconds_to_milliseconds(s: seconds) -> milliseconds:
    ...
    """
    return s * k_milliseconds_per_second
