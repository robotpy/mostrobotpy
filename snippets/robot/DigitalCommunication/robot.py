...
class MyRobot(wpilib.TimedRobot):
    ...
    def __init__(self):
        ...
        self.alliance_output = wpilib.DigitalOutput(self.K_ALLIANCE_PORT)
        self.enabled_output = wpilib.DigitalOutput(self.K_ENABLED_PORT)
        self.autonomous_output = wpilib.DigitalOutput(self.K_AUTONOMOUS_PORT)
        self.alert_output = wpilib.DigitalOutput(self.K_ALERT_PORT)
