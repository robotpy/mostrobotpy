...
K_SOLENOID_BUTTON = 1
K_DOUBLE_SOLENOID_FORWARD_BUTTON = 2
K_DOUBLE_SOLENOID_REVERSE_BUTTON = 3
K_COMPRESSOR_BUTTON = 4
...
class MyRobot(wpilib.TimedRobot):
    ...
    def teleop_periodic(self) -> None:
        ...
        elif self.joystick.get_raw_button_pressed(K_DOUBLE_SOLENOID_REVERSE_BUTTON):
            self.double_solenoid.set(wpilib.DoubleSolenoid.Value.REVERSE)

        # On button press, toggle the compressor.
        if self.joystick.get_raw_button_pressed(K_COMPRESSOR_BUTTON):
