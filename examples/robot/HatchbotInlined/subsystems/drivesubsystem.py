...
class DriveSubsystem(commands2.Subsystem):
    def __init__(self) -> None:
        ...
        self.left1 = wpilib.PWMVictorSPX(constants.K_LEFT_MOTOR_1_PORT)
        self.left2 = wpilib.PWMVictorSPX(constants.K_LEFT_MOTOR_2_PORT)
        self.right1 = wpilib.PWMVictorSPX(constants.K_RIGHT_MOTOR_1_PORT)
        self.right2 = wpilib.PWMVictorSPX(constants.K_RIGHT_MOTOR_2_PORT)
        ...
        self.left_encoder = wpilib.Encoder(
            *constants.K_LEFT_ENCODER_PORTS,
            reverse_direction=constants.K_LEFT_ENCODER_REVERSED
        )

        # The right-side drive encoder
        self.right_encoder = wpilib.Encoder(
            *constants.K_RIGHT_ENCODER_PORTS,
            reverse_direction=constants.K_RIGHT_ENCODER_REVERSED
        )

        # Sets the distance per pulse for the encoders
        self.left_encoder.set_distance_per_pulse(constants.K_ENCODER_DISTANCE_PER_PULSE)
        self.right_encoder.set_distance_per_pulse(constants.K_ENCODER_DISTANCE_PER_PULSE)
    ...
    def get_average_encoder_distance(self) -> float:
        ...
        return (self.left_encoder.get_distance() + self.right_encoder.get_distance()) / 2.0
