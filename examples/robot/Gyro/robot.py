...
class MyRobot(wpilib.TimedRobot):
    ...
    K_ANGLE_SETPOINT = 0.0
    K_P = 0.005  # proportional turning constant

    K_LEFT_MOTOR_PORT = 0
    K_RIGHT_MOTOR_PORT = 1
    ...
    def __init__(self) -> None:
        ...
        self.left_drive = wpilib.PWMSparkMax(self.K_LEFT_MOTOR_PORT)
        self.right_drive = wpilib.PWMSparkMax(self.K_RIGHT_MOTOR_PORT)
    ...
    def teleop_periodic(self) -> None:
        ...
        turning_value = (
            self.K_ANGLE_SETPOINT - self.imu.get_rotation_2_d().degrees()
        ) * self.K_P
