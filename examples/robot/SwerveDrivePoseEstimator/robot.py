...
class MyRobot(wpilib.TimedRobot):
    ...
    def drive_with_joystick(self, field_relative: bool) -> None:
        ...
        x_velocity = -self.xvelocity_limiter.calculate(self.controller.get_left_y())
        x_velocity *= Drivetrain.K_MAX_VELOCITY

        # Get the y velocity or sideways/strafe velocity. We are inverting this because
        # we want a positive value when we pull to the left. Xbox controllers
        # return positive values when you pull to the right by default.
        y_velocity = -self.yvelocity_limiter.calculate(self.controller.get_left_x())
        y_velocity *= Drivetrain.K_MAX_VELOCITY
        ...
        rot *= Drivetrain.K_MAX_ANGULAR_VELOCITY
