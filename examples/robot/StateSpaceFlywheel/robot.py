...
K_SPIN_UP_RAD_PER_SEC = 500.0
K_FLYWHEEL_MOMENT_OF_INERTIA = 0.00032  # kg/m^2
...
class MyRobot(wpilib.TimedRobot):
    ...
    def __init__(self) -> None:
        ...
        self.K_SPIN_UP_RAD_PER_SEC = wpimath.units.rotations_per_minute_to_radians_per_second(500)
    ...
    def teleop_periodic(self) -> None:
        ...
        if self.joystick.get_trigger_pressed():
            ...
            self.loop.set_next_r([K_SPIN_UP_RAD_PER_SEC])
