...
class Drive(Subsystem):
    ...
    def __init__(self) -> None:
        ...
        self.left_motor = PWMSparkMax(DriveConstants.K_LEFT_MOTOR_1_PORT)

        # The motors on the right side of the drive.
        self.right_motor = PWMSparkMax(DriveConstants.K_RIGHT_MOTOR_1_PORT)
        ...
        self.left_motor.add_follower(PWMSparkMax(DriveConstants.K_LEFT_MOTOR_2_PORT))
        self.right_motor.add_follower(PWMSparkMax(DriveConstants.K_RIGHT_MOTOR_2_PORT))
    ...
    def _log(self, sys_id_routine: SysIdRoutineLog) -> None:
        ...
        sys_id_routine.motor("drive-left").voltage(
            self.left_motor.get() * RobotController.get_battery_voltage()
        ...
        sys_id_routine.motor("drive-right").voltage(
            self.right_motor.get() * RobotController.get_battery_voltage()
