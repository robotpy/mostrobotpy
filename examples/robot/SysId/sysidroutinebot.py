...
class SysIdRoutineBot:
    ...
    def __init__(self) -> None:
        ...
        self.controller = CommandNiDsXboxController(OIConstants.K_DRIVER_CONTROLLER_PORT)
    ...
    def configure_bindings(self) -> None:
        ...
        self.controller.a().and_(self.controller.right_bumper()).while_true(
            self.drive.sys_id_quasistatic(SysIdRoutine.Direction.K_FORWARD)
        )
        self.controller.b().and_(self.controller.right_bumper()).while_true(
            self.drive.sys_id_quasistatic(SysIdRoutine.Direction.K_REVERSE)
        )
        self.controller.x().and_(self.controller.right_bumper()).while_true(
            self.drive.sys_id_dynamic(SysIdRoutine.Direction.K_FORWARD)
        )
        self.controller.y().and_(self.controller.right_bumper()).while_true(
            self.drive.sys_id_dynamic(SysIdRoutine.Direction.K_REVERSE)
        )
        ...
        self.controller.a().and_(self.controller.left_bumper()).while_true(
            self.shooter.sys_id_quasistatic(SysIdRoutine.Direction.K_FORWARD)
        )
        self.controller.b().and_(self.controller.left_bumper()).while_true(
            self.shooter.sys_id_quasistatic(SysIdRoutine.Direction.K_REVERSE)
        )
        self.controller.x().and_(self.controller.left_bumper()).while_true(
            self.shooter.sys_id_dynamic(SysIdRoutine.Direction.K_FORWARD)
        )
        self.controller.y().and_(self.controller.left_bumper()).while_true(
            self.shooter.sys_id_dynamic(SysIdRoutine.Direction.K_REVERSE)
        )
