...
class Drivetrain(commands2.Subsystem):
    ...
    def __init__(self) -> None:
        ...
        self.left_encoder.set_distance_per_pulse(
            (math.pi * self.K_WHEEL_DIAMETER_INCH) / self.K_COUNTS_PER_REVOLUTION
        )
    ...
    def arcade_drive(self, xaxis_velocity: float, zaxis_rotate: float) -> None:
        """
        ...
        """
        self.drive.arcade_drive(xaxis_velocity, zaxis_rotate)
