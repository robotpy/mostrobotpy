...
class RobotContainer:
    ...
    def _configure_button_bindings(self):
        ...
        onboard_button_a = commands2.button.Trigger(self.onboard_io.get_user_button_pressed)
        onboard_button_a.on_true(commands2.PrintCommand("USER Button Pressed")).on_false(
