...
class RobotContainer:
    ...
    def __init__(self) -> None:
        ...
        self.driver_controller = wpilib.Joystick(constants.K_DRIVER_CONTROLLER_PORT)
        ...
        self.simple_auto = DriveDistance(
            constants.K_AUTO_DRIVE_DISTANCE_INCHES, constants.K_AUTO_DRIVE_VELOCITY, self.drive
        )
