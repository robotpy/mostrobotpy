...
K_JOYSTICK_PORT = 0
K_RAISED_POSITION = wpimath.units.degrees_to_radians(90.0)
K_LOWERED_POSITION = wpimath.units.degrees_to_radians(0.0)
...
class MyRobot(wpilib.TimedRobot):
    ...
    def teleop_periodic(self) -> None:
        ...
        if self.joystick.get_trigger():
            ...
            goal = wpimath.TrapezoidProfile.State(K_RAISED_POSITION, 0.0)

        else:
            # Otherwise, we go to the low goal
            goal = wpimath.TrapezoidProfile.State(K_LOWERED_POSITION, 0.0)
