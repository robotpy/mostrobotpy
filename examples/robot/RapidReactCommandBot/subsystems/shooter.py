...
class Shooter(Subsystem):
    def __init__(self) -> None:
        ...
        super().__init__()
        self.shooter_motor = wpilib.PWMSparkMax(ShooterConstants.K_SHOOTER_MOTOR_PORT)
        self.feeder_motor = wpilib.PWMSparkMax(ShooterConstants.K_FEEDER_MOTOR_PORT)
        ...
        self.shooter_feedforward = wpimath.SimpleMotorFeedforwardMeters(
            ShooterConstants.K_S, ShooterConstants.K_V
        )
        self.shooter_feedback = wpimath.PIDController(ShooterConstants.K_P, 0.0, 0.0)

        self.shooter_feedback.set_tolerance(ShooterConstants.K_SHOOTER_TOLERANCE_RPS)
