...
class Pneumatics(Subsystem):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.pressure_transducer = wpilib.AnalogPotentiometer(
            # the AnalogIn port
            2,
            self.K_SCALE,
            self.K_OFFSET,
    ...
    def get_pressure(self) -> float:
        ...
        return self.pressure_transducer.get()

    def disable_compressor_command(self) -> Command:
