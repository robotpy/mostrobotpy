...
class RapidReactCommandBot:
    ...
    def __init__(self) -> None:
        ...
        self.driver_controller = CommandNiDsXboxController(
            OIConstants.K_DRIVER_CONTROLLER_PORT
        )
    ...
    def configure_bindings(self) -> None:
        ...
        self.driver_controller.a().on_true(
            commands2.cmd.parallel(
                self.shooter.shoot_command(ShooterConstants.K_SHOOTER_TARGET_RPS),
    ...
    def get_autonomous_command(self) -> commands2.Command:
        ...
        return self.drive.drive_distance_command(
            AutoConstants.K_DRIVE_DISTANCE, AutoConstants.K_DRIVE_VELOCITY
        ).with_timeout(AutoConstants.K_TIMEOUT)
