...
class MyRobot(wpilib.TimedRobot):
    ...
    def __init__(self) -> None:
        ...
        self.joystick = wpilib.Joystick(constants.K_JOYSTICK_PORT)
    ...
    def teleop_periodic(self) -> None:
        if self.joystick.get_trigger():
            ...
            self.elevator.reach_goal(constants.K_SETPOINT)
        else:
            # Otherwise, we update the setpoint to 1 meter.
            self.elevator.reach_goal(constants.K_LOWERK_SETPOINT)
