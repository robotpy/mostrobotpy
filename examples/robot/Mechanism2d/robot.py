...
class MyRobot(wpilib.TimedRobot):
    ...
    K_METERS_PER_PULSE = 0.01
    K_ELEVATOR_MINIMUM_LENGTH = 0.5
    ...
    def __init__(self):
        ...
        self.elevator_encoder.set_distance_per_pulse(self.K_METERS_PER_PULSE)
        ...
        self.elevator = self.root.append_ligament(
            "elevator", self.K_ELEVATOR_MINIMUM_LENGTH, 90
        )
    ...
    def robot_periodic(self):
        ...
        self.elevator.set_length(
            self.K_ELEVATOR_MINIMUM_LENGTH + self.elevator_encoder.get_distance()
        )
