...
K_JOYSTICK_PORT = 0
K_SPINUP_RAD_PER_SEC = wpimath.units.rotations_per_minute_to_radians_per_second(500.0)
...
class MyRobot(wpilib.TimedRobot):
    ...
    def __init__(self) -> None:
        ...
        self.flywheel_plant = wpimath.Models.flywheel_from_sys_id(K_FLYWHEEL_KV, K_FLYWHEEL_KA)
    ...
    def teleop_periodic(self) -> None:
        ...
        if self.joystick.get_trigger_pressed():
            ...
            self.loop.set_next_r([K_SPINUP_RAD_PER_SEC])
